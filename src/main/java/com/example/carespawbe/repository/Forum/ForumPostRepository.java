...
//    );
    ...
    @Query("""
        SELECT DISTINCT p FROM ForumPostEntity p
        LEFT JOIN FETCH p.toCategories tc
        LEFT JOIN FETCH tc.forumPostCategoryEntity
    """)
    List<ForumPostEntity> findAllWithCategories();
